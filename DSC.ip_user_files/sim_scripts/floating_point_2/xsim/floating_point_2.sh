...
#
# Script generated by Vivado on Sun Nov 23 19:56:54 +0530 2025
...
# script info
echo -e "floating_point_2.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_23 -L floating_point_v7_1_20 -L secureip -L xpm --snapshot floating_point_2 xil_defaultlib.floating_point_2 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim floating_point_2 -key {Behavioral:sim_1:Functional:floating_point_2} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
