...
HD_PWD='C:/Users/ASUS/OneDrive/Documents/DSC/DSC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assymetry_calc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assymetry_calc.tcl
